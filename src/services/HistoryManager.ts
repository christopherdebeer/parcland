...
export class HistoryManager {
    ...
    private setState: (state: { canvasState: CanvasState; viewState: ViewState }) => void;
    ...
    constructor(
        ...
        setState: (state: { canvasState: CanvasState; viewState: ViewState }) => void,
    ...
    private _stepHistory(
        ...
        const cur = this._createSnapshot();
        toStack.push(cur);

        // Restore previous state
        const { data } = fromStack.pop()!;
