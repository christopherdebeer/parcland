...
export class ViewportManager {
  ...
  /**
   * Set view state
   * IMPORTANT: Mutates the existing viewState object to maintain reference equality.
   */
  setViewState(state: Partial<ViewState>): void {
    // Mutate in place to maintain reference equality
  ...
  updateCanvasTransform(): void {
    ...
    this.container.style.setProperty(
      "--translateX",
      String(this.viewState.translateX),
    );
    this.container.style.setProperty(
      "--translateY",
      String(this.viewState.translateY),
    );
  ...
  zoom(scaleDelta: number, centerX?: number, centerY?: number): void {
    ...
    if (centerX !== undefined && centerY !== undefined) {
      ...
      const newScreenPt = {
        x:
          canvasPt.x * newScale +
          this.viewState.translateX +
          this.canvas.offsetLeft,
        y:
          canvasPt.y * newScale +
          this.viewState.translateY +
