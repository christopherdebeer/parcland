      ...
      fc.assert(
        fc.property(
          ...
          (dx, dy) => {
            ...
            const manager1 = new ViewportManager(
              canvasElement1,
              containerElement1,
              edgesLayer1,
              "test-canvas-1",
            ...
            const manager2 = new ViewportManager(
              canvasElement2,
              containerElement2,
              edgesLayer2,
              "test-canvas-2",
            ...
            expect(manager1.getViewState().translateX).toBe(
              manager2.getViewState().translateX,
            );
            expect(manager1.getViewState().translateY).toBe(
              manager2.getViewState().translateY,
            );
          },
        ),
      );
    ...
    it("viewState mutations should persist", () => {
      fc.assert(
        fc.property(viewStateArbitrary, (randomViewState) => {
          ...
          expect(manager.getViewState().translateX).toBe(
            randomViewState.translateX,
          );
          expect(manager.getViewState().translateY).toBe(
  ...
  describe("SelectionManager", () => {
    it("selection should be idempotent", () => {
      fc.assert(
        fc.property(
          fc.array(
            fc.string({ minLength: 1, maxLength: 10 }).map((s) => `id-${s}`),
